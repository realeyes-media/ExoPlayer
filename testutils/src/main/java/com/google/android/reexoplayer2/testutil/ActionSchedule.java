 ...
 */
package com.google.android.reexoplayer2.testutil;
...
import com.google.android.reexoplayer2.PlayerMessage.Target;
...
import com.google.android.reexoplayer2.testutil.Action.ClearVideoSurface;
import com.google.android.reexoplayer2.testutil.Action.ExecuteRunnable;
import com.google.android.reexoplayer2.testutil.Action.PlayUntilPosition;
import com.google.android.reexoplayer2.testutil.Action.PrepareSource;
import com.google.android.reexoplayer2.testutil.Action.Seek;
import com.google.android.reexoplayer2.testutil.Action.SendMessages;
import com.google.android.reexoplayer2.testutil.Action.SetPlayWhenReady;
import com.google.android.reexoplayer2.testutil.Action.SetPlaybackParameters;
import com.google.android.reexoplayer2.testutil.Action.SetRendererDisabled;
import com.google.android.reexoplayer2.testutil.Action.SetRepeatMode;
import com.google.android.reexoplayer2.testutil.Action.SetShuffleModeEnabled;
import com.google.android.reexoplayer2.testutil.Action.SetVideoSurface;
import com.google.android.reexoplayer2.testutil.Action.Stop;
import com.google.android.reexoplayer2.testutil.Action.ThrowPlaybackException;
import com.google.android.reexoplayer2.testutil.Action.WaitForIsLoading;
import com.google.android.reexoplayer2.testutil.Action.WaitForPlaybackState;
import com.google.android.reexoplayer2.testutil.Action.WaitForPositionDiscontinuity;
import com.google.android.reexoplayer2.testutil.Action.WaitForSeekProcessed;
import com.google.android.reexoplayer2.testutil.Action.WaitForTimelineChanged;
...
import com.google.android.reexoplayer2.util.HandlerWrapper;
...
public final class ActionSchedule {
  ...
  public static final class Builder {
    ...
    /**
     * Schedules a new source preparation action to be executed.
     * @see com.google.android.reexoplayer2.ExoPlayer#prepare(MediaSource, boolean, boolean).
     *
     * @return The builder, for convenience.
     */
