...
import com.google.android.reexoplayer2.audio.AudioCapabilities;
import com.google.android.reexoplayer2.audio.AudioProcessor;
import com.google.android.reexoplayer2.audio.AudioRendererEventListener;
import com.google.android.reexoplayer2.audio.MediaCodecAudioRenderer;
...
import com.google.android.reexoplayer2.mediacodec.MediaCodecSelector;
import com.google.android.reexoplayer2.metadata.MetadataOutput;
import com.google.android.reexoplayer2.metadata.MetadataRenderer;
import com.google.android.reexoplayer2.text.TextOutput;
import com.google.android.reexoplayer2.text.TextRenderer;
import com.google.android.reexoplayer2.trackselection.TrackSelector;
import com.google.android.reexoplayer2.util.Log;
import com.google.android.reexoplayer2.video.MediaCodecVideoRenderer;
import com.google.android.reexoplayer2.video.VideoRendererEventListener;
import com.google.android.reexoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.reexoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              boolean.class,
              long.class,
              android.os.Handler.class,
              com.google.android.reexoplayer2.video.VideoRendererEventListener.class,
              int.class);
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.reexoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.reexoplayer2.audio.AudioRendererEventListener.class,
              com.google.android.reexoplayer2.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.reexoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.reexoplayer2.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.reexoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.reexoplayer2.audio.AudioRendererEventListener.class,
