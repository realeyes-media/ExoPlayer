...
public abstract class DownloadAction {
  ...
  public static synchronized Deserializer[] getDefaultDeserializers() {
    ...
    try {
      // LINT.IfChange
      clazz = Class.forName("com.google.android.reexoplayer2.source.dash.offline.DashDownloadAction");
    ...
    try {
      // LINT.IfChange
      clazz = Class.forName("com.google.android.reexoplayer2.source.hls.offline.HlsDownloadAction");
    ...
    try {
      ...
      clazz =
          Class.forName(
                  "com.google.android.reexoplayer2.source.smoothstreaming.offline.SsDownloadAction");
