...
import com.google.android.reexoplayer2.analytics.AnalyticsCollector;
...
import com.google.android.reexoplayer2.audio.AudioFocusManager;
import com.google.android.reexoplayer2.audio.AudioListener;
import com.google.android.reexoplayer2.audio.AudioRendererEventListener;
import com.google.android.reexoplayer2.audio.AuxEffectInfo;
...
import com.google.android.reexoplayer2.metadata.MetadataOutput;
import com.google.android.reexoplayer2.source.MediaSource;
import com.google.android.reexoplayer2.source.TrackGroupArray;
import com.google.android.reexoplayer2.text.Cue;
import com.google.android.reexoplayer2.text.TextOutput;
import com.google.android.reexoplayer2.trackselection.TrackSelectionArray;
import com.google.android.reexoplayer2.trackselection.TrackSelector;
...
import com.google.android.reexoplayer2.video.VideoFrameMetadataListener;
import com.google.android.reexoplayer2.video.VideoRendererEventListener;
import com.google.android.reexoplayer2.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.google.android.reexoplayer2.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.google.android.reexoplayer2.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.google.android.reexoplayer2.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.google.android.reexoplayer2.video.VideoListener listener) {
    videoListeners.add(listener);
  }

  @Override
  public void removeVideoListener(com.google.android.reexoplayer2.video.VideoListener listener) {
   ...
   * @deprecated Use {@link #addVideoListener(com.google.android.reexoplayer2.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.google.android.reexoplayer2.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.google.android.reexoplayer2.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.google.android.reexoplayer2.video.VideoListener videoListener : videoListeners) {
