...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.reexoplayer2.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.reexoplayer2.util.TraceUtil}
   * trace enabled.
   */
