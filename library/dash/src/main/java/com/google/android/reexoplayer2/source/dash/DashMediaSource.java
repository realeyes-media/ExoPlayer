...
import com.google.android.reexoplayer2.ExoPlayerLibraryInfo;
import com.google.android.reexoplayer2.ParserException;
import com.google.android.reexoplayer2.Timeline;
import com.google.android.reexoplayer2.source.BaseMediaSource;
import com.google.android.reexoplayer2.source.CompositeSequenceableLoaderFactory;
import com.google.android.reexoplayer2.source.DefaultCompositeSequenceableLoaderFactory;
import com.google.android.reexoplayer2.source.MediaPeriod;
...
import com.google.android.reexoplayer2.source.SequenceableLoader;
import com.google.android.reexoplayer2.source.ads.AdsMediaSource;
import com.google.android.reexoplayer2.source.dash.PlayerEmsgHandler.PlayerEmsgCallback;
...
import com.google.android.reexoplayer2.source.dash.manifest.UtcTimingElement;
...
import com.google.android.reexoplayer2.upstream.Loader;
import com.google.android.reexoplayer2.upstream.Loader.LoadErrorAction;
...
import com.google.android.reexoplayer2.util.Assertions;
import com.google.android.reexoplayer2.util.Log;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements AdsMediaSource.MediaSourceFactory {
     ...
     * com.google.android.reexoplayer2.Timeline} of the source as {@link
     * com.google.android.reexoplayer2.Timeline.Window#tag}.
     *
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            com.google.android.reexoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.google.android.reexoplayer2.source.dash.manifest.Period period =
